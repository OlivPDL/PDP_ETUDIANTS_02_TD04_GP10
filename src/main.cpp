...
const char* wifi_ssid = "fegouz de souz";
const char* wifi_password = "indica2001";
...
const char* client_id = "TD04_GP10";
...
connect_wifi(); 
  ...
  if (isnan(event.temperature)) {
    ...
    temp_measure=float(temp_measure);
  }
  ...
  mqtt_client.publish("TD04_GP10/temp", String(temp_measure).c_str());
  mqtt_client.publish("TD04_GP10/relhum", String(relative_humidity_measure).c_str());
  }
